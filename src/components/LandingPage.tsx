...
import { Scissors, Calendar, Award, Star, Clock, MapPin, Phone, Instagram, Facebook, Twitter, ChevronRight } from 'lucide-react';
...
const LandingPage: React.FC<LandingPageProps> = ({ onLogin, onJoin }) => {
    const heroImage = "https://images.pexels.com/photos/1813272/pexels-photo-1813272.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2";
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex justify-between items-center h-16">
                        <div className="flex items-center gap-2">
                            ...
                            <span className="text-xl font-bold tracking-tight text-slate-900">Barbería Premium</span>
                        </div>
                        <div className="hidden md:flex items-center gap-8">
                            <a href="#services" className="text-sm font-medium text-slate-600 hover:text-blue-600 transition-colors">Servicios</a>
                            <a href="#about" className="text-sm font-medium text-slate-600 hover:text-blue-600 transition-colors">Nosotros</a>
                            <a href="#gallery" className="text-sm font-medium text-slate-600 hover:text-blue-600 transition-colors">Estilos</a>
                            <button
                                onClick={onLogin}
                    ...
                    <div className="relative z-10 grid md:grid-cols-2 gap-12 items-center">
                        <div className="text-center md:text-left space-y-8">
                            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-blue-50 text-blue-700 border border-blue-100 animate-fade-in">
                                ...
                                <span className="text-xs font-bold uppercase tracking-wider">La mejor barbería de la ciudad</span>
                            </div>
                            <h1 className="text-5xl md:text-7xl font-extrabold text-slate-900 leading-[1.1] tracking-tight">
                                Eleva tu <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-indigo-600">Estilo</span><br />
                                con Maestría
                            </h1>
                            <p className="text-lg text-slate-600 max-w-xl mx-auto md:mx-0 leading-relaxed">
                                Combinamos técnicas tradicionales con arte moderno para ofrecerte un servicio excepcional. Más que un corte, es una experiencia de cuidado personal.
                            </p>
                            ...
                            <div className="flex items-center gap-8 justify-center md:justify-start pt-8 border-t border-slate-100">
                                <div>
                                    ...
                                    <div className="text-xs text-slate-500 font-medium">Clientes Felices</div>
                                </div>
                                <div>
                                    <div className="text-2xl font-bold text-slate-900">15+</div>
                                    <div className="text-xs text-slate-500 font-medium">Años de Experticia</div>
                                </div>
                                <div>
                                    <div className="text-2xl font-bold text-slate-900">4.9/5</div>
                                    <div className="text-xs text-slate-500 font-medium">Rating Promedio</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="relative group">
                            ...
                            <div className="relative rounded-3xl overflow-hidden shadow-2xl shadow-blue-100 aspect-[4/5] transform hover:scale-[1.02] transition-transform duration-500">
                                ...
                                <div className="absolute inset-0 bg-gradient-to-t from-slate-900/60 to-transparent flex flex-col justify-end p-8 text-white">
                                    <div className="flex items-center gap-3 mb-2">
                                        ...
                                        <span className="text-sm font-semibold">+10 citas para hoy</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="absolute -bottom-6 -left-6 bg-white p-4 rounded-2xl shadow-xl flex items-center gap-4 animate-bounce-subtle">
                                ...
                                <div>
                                    <div className="text-xs text-slate-500 font-medium">Próximo Turno</div>
                                    <div className="text-sm font-bold text-slate-900">Disponible 10:30 AM</div>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <section id="services" className="py-24 bg-white relative overflow-hidden">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center max-w-2xl mx-auto mb-16 space-y-4">
                        <h2 className="text-sm font-bold text-blue-600 uppercase tracking-widest">Nuestros Servicios</h2>
                        <p className="text-3xl md:text-4xl font-extrabold text-slate-900">Experiencias de Cuidado Diseñadas Para Ti</p>
                        <p className="text-slate-600">Desde cortes clásicos hasta el diseño de barba más detallado, nuestro equipo está listo para transformar tu imagen.</p>
                    </div>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-6">
                        <div className="max-w-xl space-y-4">
                            <h2 className="text-sm font-bold text-blue-600 uppercase tracking-widest">Catálogo de Estilos</h2>
                            <p className="text-3xl md:text-4xl font-extrabold text-slate-900">Encuentra Tu Referencia Ideal</p>
                        </div>
                        <button
                            onClick={onLogin}
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                        {[
                            ...
                            <div key={idx} className="relative group rounded-3xl overflow-hidden aspect-square shadow-lg">
                                <img src={style.img} alt={style.name} className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700" />
                                <div className="absolute inset-0 bg-gradient-to-t from-slate-900/80 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity flex flex-col justify-end p-6">
                                    <div className="text-xs font-bold text-blue-400 uppercase tracking-widest mb-1">{style.id}</div>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="text-sm text-slate-400 font-medium">Cortes Realizados</div>
                        </div>
                        <div className="space-y-2">
                            <div className="text-4xl font-extrabold text-blue-400">5</div>
                            <div className="text-sm text-slate-400 font-medium">Barberos Expertos</div>
                        </div>
                        <div className="space-y-2">
                            <div className="text-4xl font-extrabold text-blue-400">1k+</div>
                            <div className="text-sm text-slate-400 font-medium">Miembros Gold</div>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <footer className="bg-white border-t border-slate-100 pt-20 pb-10">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid md:grid-cols-4 gap-12 mb-16">
                        <div className="col-span-1 md:col-span-2 space-y-6">
                            <div className="flex items-center gap-2">
                                ...
                                <span className="text-xl font-bold text-slate-900 tracking-tight">Barbería Premium</span>
                            </div>
                            <p className="text-slate-600 max-w-sm leading-relaxed">
                                Nuestra misión es ayudar a cada cliente a encontrar su mejor versión a través de un servicio de alta calidad.
                            </p>
                            <div className="flex gap-4">
                                <a href="#" className="p-3 rounded-full bg-slate-50 text-slate-400 hover:bg-blue-50 hover:text-blue-600 transition-all">
                        ...
                        <div className="space-y-6">
                            <h4 className="text-sm font-bold text-slate-900 uppercase tracking-widest">Contacto</h4>
                        ...
                        <div className="space-y-6">
                            <h4 className="text-sm font-bold text-slate-900 uppercase tracking-widest">Horario</h4>
                    ...
                    <div className="pt-8 border-t border-slate-100 flex flex-col md:row justify-between items-center gap-4">
                        <p className="text-sm text-slate-500 font-medium">© 2026 Barbería Premium. Todos los derechos reservados.</p>
